...
@Component({
  selector: 'app-request-responsibility-admin',
  standalone: true,
  ...
  templateUrl: './request-responsibility-admin.component.html',
  styleUrls: ['./request-responsibility-admin.component.scss']
})
export class RequestResponsibilityAdminComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<RequestResponsibilityAdminComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.editJobTitle) {
      ...
      this.responsibilityService.responsibilityGetById({ responsibilityid: this.id }).subscribe(
        {
          next: data => {
