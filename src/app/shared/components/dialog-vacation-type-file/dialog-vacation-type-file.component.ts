...
@Component({
  selector: 'app-dialog-vacation-type-file',
  standalone: true,
  ...
  templateUrl: './dialog-vacation-type-file.component.html',
  styleUrls: ['./dialog-vacation-type-file.component.scss']
})
export class DialogVacationTypeFileComponent {
  loading = false;
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogVacationTypeFileComponent>,
