...
@Component({
  selector: 'app-dialog-vacation-file',
  standalone: true,
  ...
  templateUrl: './dialog-vacation-file.component.html',
  styleUrls: ['./dialog-vacation-file.component.scss']
})
export class DialogVacationFileComponent {
  loading = false;
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogVacationFileComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.id) {
      ...
      this.vacationsService.vacationGetInfo({ requestId: this.id }).subscribe(
        {
