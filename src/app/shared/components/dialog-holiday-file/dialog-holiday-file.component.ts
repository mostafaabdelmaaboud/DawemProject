...
@Component({
  selector: 'app-dialog-holiday-file',
  standalone: true,
  ...
  templateUrl: './dialog-holiday-file.component.html',
  styleUrls: ['./dialog-holiday-file.component.scss']
})
export class DialogHolidayFileComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogHolidayFileComponent>,
