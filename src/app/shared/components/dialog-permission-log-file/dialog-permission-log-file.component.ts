...
import { PermissionLogService } from 'src/app/Presentation/user/permission-log/services/permission-log.service';
...
@Component({
  selector: 'app-dialog-permission-log-file',
  standalone: true,
  ...
  templateUrl: './dialog-permission-log-file.component.html',
  styleUrls: ['./dialog-permission-log-file.component.scss']
})
export class DialogPermissionLogFileComponent {
  loading = false;
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogPermissionLogFileComponent>,
