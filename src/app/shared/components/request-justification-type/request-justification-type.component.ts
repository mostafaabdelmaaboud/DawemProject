...
import { JustificationsTypeService } from 'src/app/Presentation/user/justifications-type/services/justifications-type.service';
...
@Component({
  selector: 'app-request-justification-type',
  standalone: true,
  ...
  templateUrl: './request-justification-type.component.html',
  styleUrls: ['./request-justification-type.component.scss']
})
export class RequestJustificationTypeComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<RequestJustificationTypeComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.editJustification) {
      ...
      this.justificationsTypeService.jusificationGetById({ justificationTypeId: this.id }).subscribe(
        {
          next: data => {
