...
@Component({
  selector: 'app-dialog-user-permission-file-admin',
  standalone: true,
  imports: [CommonModule, MatDialogModule, TranslateModule,
    SharedModule],  templateUrl: './dialog-user-permission-file-admin.component.html',
  styleUrls: ['./dialog-user-permission-file-admin.component.scss']
})
export class DialogUserPermissionFileAdminComponent {
  date!: Date;
  arabic: any;
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogUserPermissionFileAdminComponent>,
