...
@Component({
  selector: 'app-request-responsibility',
  standalone: true,
  ...
  templateUrl: './request-responsibility.component.html',
  styleUrls: ['./request-responsibility.component.scss']
})
export class RequestResponsibilityComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<RequestResponsibilityComponent>,
