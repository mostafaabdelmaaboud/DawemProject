...
@Component({
  selector: 'app-dialog-responsibility-file',
  standalone: true,
  ...
  templateUrl: './dialog-responsibility-file.component.html',
  styleUrls: ['./dialog-responsibility-file.component.scss']
})
export class DialogResponsibilityFileComponent {
  loading = false;
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogResponsibilityFileComponent>,
