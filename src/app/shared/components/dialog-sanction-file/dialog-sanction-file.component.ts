...
@Component({
  selector: 'app-dialog-sanction-file',
  standalone: true,
  ...
  templateUrl: './dialog-sanction-file.component.html',
  styleUrls: ['./dialog-sanction-file.component.scss']
})
export class DialogSanctionFileComponent {
  loading = false;
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogSanctionFileComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.id) {
      ...
      this.sanctionsService.sanctionGetInfo({ sanctionId: this.id }).subscribe(data => {
        this.info = data;
        this.loading = false;
