...
@Component({
  selector: 'app-dialog-request-vacation-with-dropdown',
  standalone: true,
  ...
  templateUrl: './dialog-request-vacation-with-dropdown.component.html',
  styleUrls: ['./dialog-request-vacation-with-dropdown.component.scss']
})
export class DialogRequestVacationWithDropdownComponent {
  ...
  @Input() list: any[] = [
    { name: "اجازة اعتيادي", time: "باقي 04", key: "1" },
    { name: "اجازة مرضية", time: "باقي 02", key: "2" },
    { name: "اجازة سنوية", time: "باقي 02", key: "3" },
    { name: "اجازة وضع", time: "--", key: "4" },
    { name: "اجازة عمرة", time: "باقي 15", key: "5" },
    { name: "اجازة غير مدفوعة", time: "باقي 30", key: "6" }
  ...
  addBranchGroupForm: FormGroup = this.fb.group({
    type: ['first'],
    setAsNecessary: [''],
    typeOfJustificakindOfHolidaytionFirst: ['', Validators.required],
    kindOfHoliday: ['', Validators.required],
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogRequestVacationWithDropdownComponent>,
