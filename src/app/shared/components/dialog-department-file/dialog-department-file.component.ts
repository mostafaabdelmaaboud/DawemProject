...
import { DepartmentService } from 'src/app/Presentation/user/department/services/department.service';
...
@Component({
  selector: 'app-dialog-department-file',
  standalone: true,
  ...
  templateUrl: './dialog-department-file.component.html',
  styleUrls: ['./dialog-department-file.component.scss']
})
export class DialogDepartmentFileComponent {
  loading = false;
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogDepartmentFileComponent>,
