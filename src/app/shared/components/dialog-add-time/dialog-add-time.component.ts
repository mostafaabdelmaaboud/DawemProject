...
interface DataDialog {
  ...
  titleCalendarThird: string;
  placeholderCalendarThird: string;
  validationCalendarThird: string;
...
export class DialogAddTimeComponent {
  ...
  addBranchGroupForm: FormGroup = this.fb.group({
    dropdownFirst: ['', Validators.required],
    calendarFirst: ['', Validators.required],
    calendarSecond: ['', Validators.required],
    calendarThird: ['', Validators.required],
    notes: ['']
  });
