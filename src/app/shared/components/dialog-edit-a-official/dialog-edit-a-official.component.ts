...
@Component({
  selector: 'app-dialog-edit-a-official',
  standalone: true,
  ...
  templateUrl: './dialog-edit-a-official.component.html',
  styleUrls: ['./dialog-edit-a-official.component.scss']
})
export class DialogEditAOfficialComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogEditAOfficialComponent>,
