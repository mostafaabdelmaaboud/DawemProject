            ...
            if (this.info?.attachments.length) {
              this.info?.attachments.forEach((attachment: any) => {
                ...
                if(validExts.indexOf(fileExt?.toLowerCase()) >= 0) {
                  ...
                  } else if(fileExt?.toLowerCase().includes("png") || fileExt?.toLowerCase().includes("jpeg") || fileExt?.toLowerCase().includes("jpg") || fileExt?.toLowerCase().includes("jpg") || fileExt?.toLowerCase().includes("gif")) {
