...
@Component({
  selector: 'app-dialog-justification-file',
  standalone: true,
  ...
  templateUrl: './dialog-justification-file.component.html',
  styleUrls: ['./dialog-justification-file.component.scss']
})
export class DialogJustificationFileComponent {
  loading = false;
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogJustificationFileComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.id) {
      ...
      this.justificationsService.justificationGetInfo({ requestId: this.id }).subscribe(
        {
