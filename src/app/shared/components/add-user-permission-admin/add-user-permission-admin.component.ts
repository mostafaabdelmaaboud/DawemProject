...
@Component({
  selector: 'app-add-user-permission-admin',
  standalone: true,
...
export class AddUserPermissionAdminComponent {
  loading = false;
  ...
  constructor(public dialogRef: MatDialogRef<AddUserPermissionAdminComponent>,
