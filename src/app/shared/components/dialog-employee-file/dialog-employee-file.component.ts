...
@Component({
  selector: 'app-dialog-employee-file',
  standalone: true,
  ...
  templateUrl: './dialog-employee-file.component.html',
  styleUrls: ['./dialog-employee-file.component.scss']
})
export class DialogEmployeeFileComponent {
  loading = false;
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogEmployeeFileComponent>,
