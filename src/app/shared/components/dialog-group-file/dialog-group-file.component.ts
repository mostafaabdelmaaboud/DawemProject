...
@Component({
  selector: 'app-dialog-group-file',
  standalone: true,
  ...
  templateUrl: './dialog-group-file.component.html',
  styleUrls: ['./dialog-group-file.component.scss']
})
export class DialogGroupFileComponent {
  loading = false;
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogGroupFileComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.id) {
      ...
      this.groupsService.groupGetInfo({ groupId: this.id }).subscribe(data => {
