...
@Component({
  selector: 'app-dialog-edit-a-section',
  standalone: true,
  ...
  templateUrl: './dialog-edit-a-section.component.html',
  styleUrls: ['./dialog-edit-a-section.component.scss']
})
export class DialogEditASectionComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogEditASectionComponent>,
