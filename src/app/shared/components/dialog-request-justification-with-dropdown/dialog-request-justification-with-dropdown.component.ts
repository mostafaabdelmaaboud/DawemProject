...
@Component({
  selector: 'app-dialog-request-justification-with-dropdown',
  standalone: true,
  ...
  templateUrl: './dialog-request-justification-with-dropdown.component.html',
  styleUrls: ['./dialog-request-justification-with-dropdown.component.scss']
})
export class DialogRequestJustificationWithDropdownComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogRequestJustificationWithDropdownComponent>,
