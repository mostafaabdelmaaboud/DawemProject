            ...
            this.schedualPlanService.schedualPlanGetById({ schedulePlanId: this.id }).subscribe(
              {
                next: data => {
                  ...
                  if (data.employeeId != null) {
                    this.schedualPlanService.departmentForDropdown({ PagingEnabled: true, PageSize: 5, PageNumber: 0, id: data.employeeId }).subscribe(dataDropdown => {
                      this.listEmployeeId = [];
                      dataDropdown.data?.forEach((list: any) => {
                  ...
                  if (data.groupId != null) {
                    this.schedualPlanService.departmentForDropdown({ PagingEnabled: true, PageSize: 5, PageNumber: 0, id: data.groupId }).subscribe(dataDropdown => {
                      this.listGroupId = [];
                      dataDropdown.data?.forEach((list: any) => {
