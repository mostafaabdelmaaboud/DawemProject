...
@Component({
  selector: 'app-dialog-permission-type',
  standalone: true,
  ...
  templateUrl: './dialog-permission-type-file.component.html',
  styleUrls: ['./dialog-permission-type-file.component.scss']
})
export class DialogPermissionTypeFileComponent {
  loading = false;
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogPermissionTypeFileComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.id) {
      ...
      this.permissionTypeService.permissionGetInfo({ permissionTypeId: this.id }).subscribe(
        {
