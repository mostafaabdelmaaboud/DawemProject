...
@Component({
  selector: 'app-dialog-overtime-type-file',
  standalone: true,
  ...
  templateUrl: './dialog-overtime-type-file.component.html',
  styleUrls: ['./dialog-overtime-type-file.component.scss']
})
export class DialogOvertimeTypeFileComponent {
 loading = false;
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogOvertimeTypeFileComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.id) {
      ...
      this.overtimeTypeService.overtimeGetInfo({ overtimeTypeId: this.id }).subscribe(
        {
