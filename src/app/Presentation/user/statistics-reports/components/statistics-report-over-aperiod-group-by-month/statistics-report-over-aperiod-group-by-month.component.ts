...
@Component({
  selector: 'app-statistics-report-over-aperiod-group-by-month',
  templateUrl: './statistics-report-over-aperiod-group-by-month.component.html',
  styleUrls: ['./statistics-report-over-aperiod-group-by-month.component.scss']
})
export class StatisticsReportOverAperiodGroupByMonthComponent {
  date!: Date;
  ...
  getReport(filteration) {
    ...
    this.reportService.getStatisticsReportOverAperiodGroupByMonthReport(filteration)
