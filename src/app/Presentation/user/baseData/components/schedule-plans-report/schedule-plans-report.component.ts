...
@Component({
  selector: 'app-schedule-plans-report',
  templateUrl: './schedule-plans-report.component.html',
  styleUrls: ['./schedule-plans-report.component.scss']
})
export class SchedulePlansReportComponent {
  date!: Date;
  ...
  getReport(filteration) {
    ...
    this.baseDataService.getSchedulePlansReport(filteration)
