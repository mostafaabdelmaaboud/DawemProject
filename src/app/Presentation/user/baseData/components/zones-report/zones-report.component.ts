...
@Component({
  selector: 'app-zones-report',
  templateUrl: './zones-report.component.html',
  styleUrls: ['./zones-report.component.scss']
})
export class ZonesReportComponent {
  date!: Date;
  ...
  getReport(filteration) {
    ...
    this.baseDataService.getZonesReport(filteration)
