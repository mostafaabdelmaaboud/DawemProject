...
@Component({
  selector: 'app-summons-report',
  templateUrl: './summons-report.component.html',
  styleUrls: ['./summons-report.component.scss']
})
export class SummonsReportComponent {
  date!: Date;
  ...
  getReport(filteration) {
    ...
    this.baseDataService.getSummonsReport(filteration)
