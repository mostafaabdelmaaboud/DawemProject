...
@Component({
  selector: 'app-summon-logs-report',
  templateUrl: './summon-logs-report.component.html',
  styleUrls: ['./summon-logs-report.component.scss']
})
export class SummonLogsReportComponent {
  date!: Date;
  ...
  getReport(filteration) {
    ...
    this.baseDataService.getSummonLogsReport(filteration)
