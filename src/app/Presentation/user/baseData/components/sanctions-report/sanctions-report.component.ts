...
@Component({
  ...
  templateUrl: './sanctions-report.component.html',
  styleUrls: ['./sanctions-report.component.scss']
})
export class SanctionsReportComponent {
  date!: Date;
  ...
  getReport(filteration) {
    ...
    this.baseDataService.getSanctionsReport(filteration)
