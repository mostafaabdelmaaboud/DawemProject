...
@Component({
  selector: 'app-attendace-leave-summary-report',
  templateUrl: './attendace-leave-summary-report.component.html',
  styleUrls: ['./attendace-leave-summary-report.component.scss']
})
export class AttendaceLeaveSummaryReportComponent {
  date!: Date;
  ...
  getReport(filteration) {
    ...
    this.reportService.getAttendaceLeaveSummaryReport(filteration).subscribe({
      next: (blob: Blob) => {
