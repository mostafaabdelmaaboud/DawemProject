...
@Component({
  selector: 'app-attendance-and-departure-details',
  templateUrl: './attendance-and-departure-details.component.html',
  styleUrls: ['./attendance-and-departure-details.component.scss']
})
export class AttendanceAndDepartureDetailsComponent {
  date!: Date;
  ...
  getReport(filteration) {
    ...
    this.reportService.getAttendanceDetailsByEmployeeIDReport(filteration).subscribe({
      next: (blob: Blob) => {
