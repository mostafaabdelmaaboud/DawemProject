...
@Component({
  ...
  templateUrl: './dialog-plan-info.component.html',
  styleUrls: ['./dialog-plan-info.component.scss']
})
export class DialogPlanInfoComponent {
  loading = false;
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogPlanInfoComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.id) {
      ...
      this.plansService.planeInfo({ planid: this.id }).subscribe(
        {
