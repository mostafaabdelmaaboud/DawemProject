...
export class PermissionLogService {
  ...
  listPermissionLog(filter: any): Observable<any> {
    ...
    return this.http.get<any>(`${environment.baseUrl}adminpanel/PermissionLog/Get`, { params: queryParams })
  }
  getInformation(): Observable<any> {

    return this.http.get<any>(`${environment.baseUrl}adminpanel/SummonLog/GetSummonLogsInformations`).pipe(map(data => data.data));
  }
  ...
  actionCodeForDropdown(params: any) {
    ...
    return this.http.get<any>(`${environment.baseUrl}adminpanel/Permission/GetAllActions`)
  }
  ...
  groupsForDropdown(params: any) {
    ...
    return this.http.get<any>(`${environment.baseUrl}adminpanel/Group/GetForDropDown`, { params: queryParams })
  }
  ...
  sanctionForDropdown(params: any) {
    ...
    return this.http.get<any>(`${environment.baseUrl}adminpanel/Sanction/GetForDropDown`, { params: queryParams })
  }
  ...
  permissionLogGetInfo(params: any) {
    ...
    return this.http.get<any>(`${environment.baseUrl}adminpanel/PermissionLog/GetInfo`, { params: queryParams }).pipe(map(data => data.data))
  }
}
