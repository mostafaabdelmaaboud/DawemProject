...
@Component({
  ...
  templateUrl: './screen-file.component.html',
  styleUrls: ['./screen-file.component.scss']
})
export class ScreenFileComponent {
  loading = false;
  ...
  constructor(
    public dialogRef: MatDialogRef<ScreenFileComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.id) {
      ...
      this.screensService.screenInfo({ screenid: this.id }).subscribe(
        {
