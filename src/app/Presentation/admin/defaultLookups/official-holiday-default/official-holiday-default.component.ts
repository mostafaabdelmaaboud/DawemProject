...
@Component({
  selector: 'app-official-holiday-default',
  templateUrl: './official-holiday-default.component.html',
  styleUrls: ['./official-holiday-default.component.scss']
})
export class OfficialHolidayDefaultComponent {
  date!: Date;
  arabic: any;
  ...
  columns: any[] = [
    {
      name: "كود الأجازة الرسمية",
      field: "code",
    },
    {
      name: "اسم الأجازة الرسمية",
      field: "name",
    },
    {
      name: "الحالة",
  ...
  exportTableToExcel() {
    ...
    if(!this.isLoading) {
      ...
      this.defaultLookupsService.getOfficialHoliday(filteration).subscribe(
        {
          next: data => {
  ...
  sendRequest(data: any) {
    ...
    this.defaultLookupsService.acceptOfficialHoliday({ OfficialHolidayId: data.id }).subscribe(
      {
        next: res => {
          this.getLookups(this.filteration);
  ...
  reasonOfRefuse(data: any) {
    let reasonOfRefuseDialog = this.dialog.open(DialogDeleteComponent, {
        width: "30vw",
        data: {
          title: "هل متأكد من حذف الأجازة الرسمية؟",
    ...
    reasonOfRefuseDialog.componentInstance.submitClicked.subscribe(result => {
      ...
      this.defaultLookupsService.deleteOfficialHoliday({ OfficialHolidayId: data.id }).subscribe({
        next: res => {
  ...
  requestLookup() {
    ...
    dialogRefAddCurrency.componentInstance.submitClicked.subscribe(result => {
      ...
      this.defaultLookupsService.createOfficialHoliday(formData).subscribe(
        {
          next: (data: any) => {
            ...
            const succressDialog = this.dialog.open(ToastSuccessComponent, {
              ...
              data: {
                ...
                buttonSend: "طلبات الأجازات الرسمية"
  ...
  editLookup(data: any) {
    ...
    dialogRefAddCurrency.componentInstance.typeGetById = 3;
    ...
    dialogRefAddCurrency.componentInstance.submitClicked.subscribe(result => {
      ...
      formData.isActive = result.IsActive;
      dialogRefAddCurrency.componentInstance.submitted = false;
      this.defaultLookupsService.updateOfficialHoliday(formData).subscribe(
        {
          next: (data: any) => {
  ...
  dialogLookupFile(data: any) {
    const dialogRefAddCurrency = this.dialog.open(LookupFileComponent, {
      width: "40vw",
      data: {
        title: "ملف الأجازة الرسمية",
        codeLabel:"كود الأجازة الرسمية ",
        translationsLabel:"أسماء الأجازة الرسمية",
        nameLabel:"أسم الأجازة الرسمية "
      },
    });
    dialogRefAddCurrency.componentInstance.id = data.id;
    dialogRefAddCurrency.componentInstance.infoType =3;
