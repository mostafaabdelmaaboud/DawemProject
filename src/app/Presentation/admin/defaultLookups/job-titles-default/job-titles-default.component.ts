...
@Component({
  selector: 'app-job-titles-default',
  templateUrl: './job-titles-default.component.html',
  styleUrls: ['./job-titles-default.component.scss']
})
export class JobTitlesDefaultComponent {
  date!: Date;
  arabic: any;
  ...
  columns: any[] = [
    {
      name: "كود المسمي الوظيفي",
      field: "code",
    },
    {
      name: "اسم المسمي الوظيفي",
      field: "name",
    },
    {
      name: "الحالة",
  ...
  exportTableToExcel() {
    ...
    if(!this.isLoading) {
      ...
      this.defaultLookupsService.getJobTitles(filteration).subscribe(
        {
          next: data => {
  ...
  sendRequest(data: any) {
    ...
    this.defaultLookupsService.acceptJobTitles({ JobTitleId: data.id }).subscribe(
      {
        next: res => {
          this.getLookups(this.filteration);
  ...
  reasonOfRefuse(data: any) {
    ...
    reasonOfRefuseDialog.componentInstance.submitClicked.subscribe(result => {
      ...
      this.defaultLookupsService.deleteJobTitles({ vacationTypeId: data.id }).subscribe({
        next: res => {
  ...
  requestLookup() {
    ...
    dialogRefAddCurrency.componentInstance.submitClicked.subscribe(result => {
      ...
      this.defaultLookupsService.createJobTitles(formData).subscribe(
        {
          next: (data: any) => {
            ...
            const succressDialog = this.dialog.open(ToastSuccessComponent, {
              ...
              data: {
                ...
                buttonSend: "طلبات المسميات الوظيفيه"
  ...
  editLookup(data: any) {
    ...
    dialogRefAddCurrency.componentInstance.typeGetById = 1;
    ...
    dialogRefAddCurrency.componentInstance.submitClicked.subscribe(result => {
      ...
      formData.isActive = result.IsActive;
      dialogRefAddCurrency.componentInstance.submitted = false;
      this.defaultLookupsService.updateJobTitles(formData).subscribe(
        {
          next: (data: any) => {
  ...
  dialogLookupFile(data: any) {
    const dialogRefAddCurrency = this.dialog.open(LookupFileComponent, {
      ...
      data: {
        ...
        codeLabel:"كود المسمي الوظيفي ",
        translationsLabel:"أسماء المسمي الوظيفي",
        nameLabel:"أسم المسمي الوظيفي "
      },
    });
    dialogRefAddCurrency.componentInstance.id = data.id;
    dialogRefAddCurrency.componentInstance.infoType =1;
