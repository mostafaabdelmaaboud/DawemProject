...
@Component({
  selector: 'app-justification-type-default',
  templateUrl: './justification-type-default.component.html',
  styleUrls: ['./justification-type-default.component.scss']
})
export class JustificationTypeDefaultComponent {
  date!: Date;
  arabic: any;
  ...
  columns: any[] = [
    {
      name: "كود انواع التبريرات",
      field: "code",
    },
    {
      name: "اسم نوع التبرير",
      field: "name",
    },
    {
      name: "الحالة",
  ...
  exportTableToExcel() {
    ...
    var options = { 
      ...
      showLabels: true, 
      showTitle: true,
      title: 'انواع التبريرات الأفتراضيه',
      useBom: true,
    ...
    if(!this.isLoading) {
      ...
      this.defaultLookupsService.getJustificationType(filteration).subscribe(
        {
          next: data => {
  ...
  sendRequest(data: any) {
    ...
    this.defaultLookupsService.acceptJustificationType({ JustificationTypeId: data.id }).subscribe(
      {
        next: res => {
          this.getLookups(this.filteration);
  ...
  reasonOfRefuse(data: any) {
    let reasonOfRefuseDialog = this.dialog.open(DialogDeleteComponent, {
        width: "30vw",
        data: {
          title: "هل متأكد من حذف نواع التبرير؟",
    ...
    reasonOfRefuseDialog.componentInstance.submitClicked.subscribe(result => {
      ...
      this.defaultLookupsService.deleteJustificationType({ JustificationTypeId: data.id }).subscribe({
        next: res => {
  ...
  requestLookup() {
    const dialogRefAddCurrency = this.dialog.open(AddLookupComponent, {
      width: "50vw",
      data: {
        title: "إضافة نوع تبرير",
        label:"إسم نوع التبرير",
    ...
    dialogRefAddCurrency.componentInstance.submitClicked.subscribe(result => {
      ...
      this.defaultLookupsService.createJustificationType(formData).subscribe(
        {
          next: (data: any) => {
            ...
            const succressDialog = this.dialog.open(ToastSuccessComponent, {
              ...
              data: {
                ...
                buttonSend: "نوع التبريرات الأفتراضية"
  ...
  editLookup(data: any) {
    ...
    dialogRefAddCurrency.componentInstance.typeGetById = 6;
    ...
    dialogRefAddCurrency.componentInstance.submitClicked.subscribe(result => {
      ...
      formData.isActive = result.IsActive;
      dialogRefAddCurrency.componentInstance.submitted = false;
      this.defaultLookupsService.updateJustificationType(formData).subscribe(
        {
          next: (data: any) => {
  ...
  dialogLookupFile(data: any) {
    const dialogRefAddCurrency = this.dialog.open(LookupFileComponent, {
      width: "40vw",
      data: {
        title: "ملف نوع التبريرات",
        codeLabel:"كود نوع التبرير ",
        translationsLabel:"أسماء نوع التبرير",
        nameLabel:"أسم نوع التبرير "
      },
    });
    dialogRefAddCurrency.componentInstance.id = data.id;
    dialogRefAddCurrency.componentInstance.infoType =6;
