...
import { AddUserComponent } from 'src/app/shared/components/add-user-admin/add-user.component';
import { DialogDeleteComponent } from 'src/app/shared/components/dialog-delete/dialog-delete.component';
import { DialogUserFileComponent } from 'src/app/shared/components/dialog-user-file-admin/dialog-user-file.component';
    ...
    this.translate.get("users").subscribe(translate => {
      dialogRefAddCurrency = this.dialog.open(AddUserComponent, {
        ...
        data: {
          ...
          Roles: "المسؤوليات <span class='color-red'>*</span>",
          placeholdeRoles: "المسؤوليات",
          ValidationRoles: "المسؤوليات مطلوبة",
